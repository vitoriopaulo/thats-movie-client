...
var config = {
  apiOrigins: {
    production: 'https://thats-movie.herokuapp.com/' // https://ga-wdi-boston.herokuapp.com for development
  }
};
...
var moviesEvents = __webpack_require__(17);
...
var onGetAllMovies = function onGetAllMovies(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.getAllMovies(data).then(ui.getAllMoviesSuccess).catch(ui.getAllMoviesFailure);
};

var onGetOneMovie = function onGetOneMovie(event) {
  var data = getFormFields(this);
  // console.log(data.movie)
  event.preventDefault();
  api.getOneMovie(data).then(ui.getOneMovieSuccess).catch(ui.getOneMovieFailure);
};

var onAddMovie = function onAddMovie(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.addMovie(data).then(ui.addMovieSuccess).catch(ui.addMovieFailure);
};
...
var onDeleteMovie = function onDeleteMovie(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.deleteMovie(data).then(ui.deleteMovieSuccess).catch(ui.deleteMovieFailure);
};

var addHandlers2 = function addHandlers2() {
...
var getOneMovie = function getOneMovie(data) {
...
var showMoviesTemplate = __webpack_require__(20);
var showMovieTemplate = __webpack_require__(37);

var getAllMoviesSuccess = function getAllMoviesSuccess(data) {
...
var getAllMoviesFailure = function getAllMoviesFailure(error) {
  console.error(error);
  $('#message_0').show().text('Error: movies not successfully loaded. Try again.').fadeOut(5000);
};

var getOneMovieSuccess = function getOneMovieSuccess(data) {
...
var getOneMovieFailure = function getOneMovieFailure(error) {
  console.error(error);
  $('.my-input').val('');
  $('#message_1').show().text('Error on getting movie. Try again.').fadeOut(5000);
};

var addMovieSuccess = function addMovieSuccess(data) {
  // console.log(data)
...
module.exports = {
  getAllMoviesSuccess: getAllMoviesSuccess,
  getAllMoviesFailure: getAllMoviesFailure,
  getOneMovieSuccess: getOneMovieSuccess,
  getOneMovieFailure: getOneMovieFailure,
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "  <h4> "
    ...
    + " </h4>\n<br>\n  <img src=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.poster : stack1), depth0))
    + "\" width=\"220px\">\n<br>\n<br>\n  <p> Sinopse: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.sinopse : stack1), depth0))
    + " </p>\n<br>\n  <p> Released in: "
    ...
    + " </p>\n<br>\n  <p> Main Actors: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.actors : stack1), depth0))
    + " </p>\n<br>\n  <p> Status: "
    ...
    + " </p>\n<br>\n  <p> <a href=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.trailer : stack1), depth0))
    + "\" target=\"_blank\"> Link to Trailer Here! </a></p>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "<li id =\"movies-list\">\n"
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<li id =\"movie-listed\">\n  <h4> "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.movie : depth0)) != null ? stack1.title : stack1), depth0))
    + " </h4>\n<br>\n  <img src=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.movie : depth0)) != null ? stack1.poster : stack1), depth0))
    + "\" width=\"220px\">\n<br>\n<br>\n  <p> Sinopse: "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.movie : depth0)) != null ? stack1.sinopse : stack1), depth0))
    + " </p>\n<br>\n  <p> Released in: "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.movie : depth0)) != null ? stack1.year : stack1), depth0))
    + " </p>\n<br>\n  <p> Directed by: "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.movie : depth0)) != null ? stack1.director : stack1), depth0))
    + " </p>\n<br>\n  <p> Main Actors: "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.movie : depth0)) != null ? stack1.actors : stack1), depth0))
    + " </p>\n<br>\n  <p> Status: "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.movie : depth0)) != null ? stack1.status : stack1), depth0))
    + " </p>\n<br>\n  <p> Comments: "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.movie : depth0)) != null ? stack1.comment : stack1), depth0))
    + " </p>\n<br>\n  <p> <a href=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.movie : depth0)) != null ? stack1.trailer : stack1), depth0))
    + "\" target=\"_blank\"> Link to Trailer Here! </a></p>\n</li>\n";
},"useData":true});
